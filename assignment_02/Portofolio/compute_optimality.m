  function [w, x_lambda, r_final, sigma, optim, lambda, ef] = compute_optimality(a, allow_short_selling)
    ...
    if allow_short_selling == 1
      [w, fv, ef, optim, lambda] = quadprog(a*Q, -(1-a)*r, [],[], Aeq, beq, [], [], [], options);
    else
      [w, fv, ef, optim, lambda] = quadprog(a*Q, -(1-a)*r, [], [], Aeq, beq, zeros(n,1), [], [], options);
    end
    KKT = [Q, Aeq.'; Aeq, 0];
